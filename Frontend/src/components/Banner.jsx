...
import BannerImage from "../../public/Banner-remove.png";

export default function Banner() {
  return (
    <>
      <div className='my-10 container max-w-screen-2xl mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
        <div className='order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32'>
          <div className='space-y-8'>
            <h1 className='text-5xl font-bold'>
              Hello, <span className='text-pink-500'>welcomes here</span> to learn something <span className='text-pink-500'>new everyday!!!</span>
            </h1>
        ...
        <div className='order-1 w-full md:w-1/2'>
          <div className='flex justify-center items-center h-full'>
            <img src={BannerImage} className='w-full h-auto' alt="Banner" />
          </div>
        </div>
      </div>
    </>
