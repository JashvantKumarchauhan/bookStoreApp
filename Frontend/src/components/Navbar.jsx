...
export default function Navbar() {
  ...
  return (
    <div className={`z-50 fixed top-0 right-0 left-0 ${theme === 'dark' ? 'dark:bg-slate-900' : 'bg-white'} w-full ${sticky ? "shadow-md bg-opacity-90" : "bg-opacity-100"} transition-all ease-in-out`}>
          ...
          <div className="navbar-end space-x-3">
...

            {
              ...
              <div>
                ...
                <a className="py-2 px-3 bg-black text-white p-2 cursor-pointer rounded-md duration-300 hover:bg-slate-800" onClick={() => document.getElementById('my_modal_3').showModal()}>
                  Login
                </a>
